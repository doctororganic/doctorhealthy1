...
app.get('/', (req, res) => {
  res.json({
    ...
    endpoints: [
      ...
      'GET /api/v1/drugs-nutrition - Drug-nutrition interactions',
      'POST /api/v1/workouts/generate - Generate workout plans'
    ]
  });
});
...
const server = app.listen(PORT, () => {
  ...
  console.log(`💊 Drug-Nutrition: http://localhost:${PORT}/api/v1/drugs-nutrition`);
});
